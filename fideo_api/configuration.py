...
class Configuration:
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.fullcontact.com/v3" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("fideo_api")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.fullcontact.com/v3",
