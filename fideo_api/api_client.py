...
from fideo_api.api_response import ApiResponse, T as ApiResponseT
import fideo_api.models
from fideo_api import rest
from fideo_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(fideo_api.models, klass)
