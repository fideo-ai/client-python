...
class PrefillApi:
    ...
    async def prefill(
        self,
        multi_field_req_with_options: MultiFieldReqWithOptions,
        ...
        :param multi_field_req_with_options: (required)
        ...
        _param = self._prefill_serialize(
    ...
    @validate_call
    async def prefill_with_http_info(
        self,
        multi_field_req_with_options: MultiFieldReqWithOptions,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def prefill_without_preload_content(
        self,
        multi_field_req_with_options: MultiFieldReqWithOptions,
        _request_timeout: Union[
            None,
