...
class SignalsApi:
    ...
    def signals_post(
        ...
        _param = self._signals_post_serialize(
            v=v,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V3VerifySignalsPost200Response",
        }
    ...
    def signals_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V3VerifySignalsPost200Response]:
        """signals_post
    ...
    def v3_verify_signals_post(
        ...
        _param = self._v3_verify_signals_post_serialize(
            v=v,
            multi_field_req_with_options=multi_field_req_with_options,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def v3_verify_signals_post_with_http_info(
        self,
        v: Optional[StrictStr] = None,
        multi_field_req_with_options: Optional[MultiFieldReqWithOptions] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def v3_verify_signals_post_without_preload_content(
        self,
        v: Optional[StrictStr] = None,
        multi_field_req_with_options: Optional[MultiFieldReqWithOptions] = None,
        _request_timeout: Union[
    ...
    def _v3_verify_signals_post_serialize(
        self,
        v,
        multi_field_req_with_options,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/verify.signals',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
