...
class VerifyApi:
    ...
    def v3_verify_match_post(
        ...
        _param = self._v3_verify_match_post_serialize(
    ...
    @validate_call
    def v3_verify_match_post_with_http_info(
        self,
        multi_field_req: Optional[MultiFieldReq] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v3_verify_match_post_without_preload_content(
        self,
        multi_field_req: Optional[MultiFieldReq] = None,
        _request_timeout: Union[
            None,
    ...
    def _v3_verify_match_post_serialize(
        self,
        multi_field_req,
        _request_auth,
        _content_type,
