...
class VerifyApi:
    ...
    def verify_match_post(
        ...
        _param = self._verify_match_post_serialize(
    ...
    @validate_call
    def verify_match_post_with_http_info(
        self,
        multi_field_req: Optional[MultiFieldReq] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def verify_match_post_without_preload_content(
        self,
        multi_field_req: Optional[MultiFieldReq] = None,
        _request_timeout: Union[
            None,
    ...
    def _verify_match_post_serialize(
        self,
        multi_field_req,
        _request_auth,
        _content_type,
