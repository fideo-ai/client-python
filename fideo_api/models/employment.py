...
class Employment(BaseModel):
    ...
    start: Optional[EmploymentDate] = None
    end: Optional[EmploymentDate] = None
    __properties: ClassVar[List[str]] = ["current", "company", "title", "domain", "start", "end"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "start": EmploymentDate.from_dict(obj["start"]) if obj.get("start") is not None else None,
            "end": EmploymentDate.from_dict(obj["end"]) if obj.get("end") is not None else None
        })
        return _obj
