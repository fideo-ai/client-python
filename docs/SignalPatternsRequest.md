...
**interval** | **str** | Time interval for timeseries data (used only for timeseries endpoint) | [optional] 
**count** | **int** | Number of data points to return (used only for timeseries endpoint) | [optional] 
